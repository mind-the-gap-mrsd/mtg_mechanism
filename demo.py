...
def coupleAndRam():
    ...
    #     amarMsg.linear.x = 0.2
    #     akbarMsg.linear.x = -0.1
    #     anthonyMsg.linear.x = -0.1
...
def crossGap(now, t):
    ...
    #     amarMsg.linear.x = 0.5
    #     akbarMsg.linear.x = 0.5
    #     anthonyMsg.linear.x = 0.5
